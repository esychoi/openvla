...
from dataset_analysis.custom_dataset import CustomRLDSDataset
...
class FinetuneConfig:
    ...
    # Directory Paths
    data_root_dir: Path = Path("/data/sample_0924/preprocessed")        # Path to Open-X dataset directory
    dataset_name: str = "dg_univ_data" # Name of fine-tuning dataset (e.g., `droid_wipe`)
    ...
    # Tracking Parameters
    wandb_project: str = "openvla-ft-dg_univ_data"                                  # Name of W&B project to log to (use default!)
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    vla_dataset = CustomRLDSDataset(cfg.data_root_dir, batch_transform)
